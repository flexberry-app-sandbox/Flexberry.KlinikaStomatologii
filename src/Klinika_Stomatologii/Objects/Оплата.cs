...
namespace IIS.Klinika_Stomatologii
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Klinika_Stomatologii.ТипОплаты fТипОплаты;
        ...
        public virtual IIS.Klinika_Stomatologii.ТипОплаты ТипОплаты
        {
            get
            {
                ...
                IIS.Klinika_Stomatologii.ТипОплаты result = this.fТипОплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Klinika_Stomatologii.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Klinika_Stomatologii.Оплата));
                }
            }
        }
    }
