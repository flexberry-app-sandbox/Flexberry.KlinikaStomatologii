...
namespace IIS.Klinika_Stomatologii
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Klinika_Stomatologii.DetailArrayOfДокументы fДокументы;
        ...
        public virtual IIS.Klinika_Stomatologii.DetailArrayOfДокументы Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new IIS.Klinika_Stomatologii.DetailArrayOfДокументы(this);
                }
                IIS.Klinika_Stomatologii.DetailArrayOfДокументы result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Klinika_Stomatologii.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Klinika_Stomatologii.Клиент));
                }
            }
        }
    }
