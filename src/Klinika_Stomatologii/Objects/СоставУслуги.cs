...
namespace IIS.Klinika_Stomatologii
{
    ...
    public class СоставУслуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Klinika_Stomatologii.Единицы fЕдиницы;
        
        private IIS.Klinika_Stomatologii.Материал fМатериал;
        ...
        public virtual IIS.Klinika_Stomatologii.Единицы Единицы
        {
            get
            {
                ...
                IIS.Klinika_Stomatologii.Единицы result = this.fЕдиницы;
        ...
        [PropertyStorage(new string[] {
                "Материал"})]
        [NotNull()]
        public virtual IIS.Klinika_Stomatologii.Материал Материал
        {
            get
            {
                ...
                IIS.Klinika_Stomatologii.Материал result = this.fМатериал;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Klinika_Stomatologii.Услуга.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставУслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставУслугиE", typeof(IIS.Klinika_Stomatologii.СоставУслуги));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставУслуги : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Klinika_Stomatologii.DetailArrayOfСоставУслуги members)

        // *** End programmer edit section *** (IIS.Klinika_Stomatologii.DetailArrayOfСоставУслуги members)
        ...
        /// </summary>
        public DetailArrayOfСоставУслуги(IIS.Klinika_Stomatologii.Услуга fУслуга) : 
                base(typeof(СоставУслуги), ((ICSSoft.STORMNET.DataObject)(fУслуга)))
        {
        }
        
        public IIS.Klinika_Stomatologii.СоставУслуги this[int index]
        {
            get
            {
                return ((IIS.Klinika_Stomatologii.СоставУслуги)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Klinika_Stomatologii.СоставУслуги dataobject)
        {
