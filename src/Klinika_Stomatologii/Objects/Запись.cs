...
namespace IIS.Klinika_Stomatologii
{
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Klinika_Stomatologii.Клиент fКлиент;
        
        private IIS.Klinika_Stomatologii.Кабинет fКабинет;
        
        private IIS.Klinika_Stomatologii.Сотрудник fСотрудник;
        
        private IIS.Klinika_Stomatologii.DetailArrayOfОказаниеУслуг fОказаниеУслуг;
        ...
        [PropertyStorage(new string[] {
                "Кабинет"})]
        [NotNull()]
        public virtual IIS.Klinika_Stomatologii.Кабинет Кабинет
        {
            get
            {
                ...
                IIS.Klinika_Stomatologii.Кабинет result = this.fКабинет;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Klinika_Stomatologii.Клиент Клиент
        {
            get
            {
                ...
                IIS.Klinika_Stomatologii.Клиент result = this.fКлиент;
        ...
        public virtual IIS.Klinika_Stomatologii.DetailArrayOfОказаниеУслуг ОказаниеУслуг
        {
            get
            {
                ...
                {
                    this.fОказаниеУслуг = new IIS.Klinika_Stomatologii.DetailArrayOfОказаниеУслуг(this);
                }
                IIS.Klinika_Stomatologii.DetailArrayOfОказаниеУслуг result = this.fОказаниеУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.Klinika_Stomatologii.Запись));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьL", typeof(IIS.Klinika_Stomatologii.Запись));
                }
            }
        }
    }
