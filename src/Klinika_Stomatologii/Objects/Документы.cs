...
namespace IIS.Klinika_Stomatologii
{
    ...
    public class Документы : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Klinika_Stomatologii.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументыE", typeof(IIS.Klinika_Stomatologii.Документы));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументы : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Klinika_Stomatologii.DetailArrayOfДокументы members)

        // *** End programmer edit section *** (IIS.Klinika_Stomatologii.DetailArrayOfДокументы members)
        ...
        /// </summary>
        public DetailArrayOfДокументы(IIS.Klinika_Stomatologii.Клиент fКлиент) : 
                base(typeof(Документы), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.Klinika_Stomatologii.Документы this[int index]
        {
            get
            {
                return ((IIS.Klinika_Stomatologii.Документы)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Klinika_Stomatologii.Документы dataobject)
        {
